...
9 月 18 日凌晨，独立开发者 ferstar 发了一篇博客《扒一扒 ZCode 静默上传全量 Git 历史的骚操作》，关于ZCode，这是是智谱官方的 AI 编程桌面客户端。

![图片](/assets/uploads/20260918-268b57fa66.webp)
...
就在刚刚，智谱在Zcode官方社群里进行了回应。官方承认上传了数据。其解释称是“代码库索引”功能导致上传了仓库数据，初衷是为了方便用户，并表示生成wiki页面后，仓库数据会被销毁，不会保存。上线初期该功能默认开启，部分用户因此受到影响，目前相关问题已经修复。

![图片](/assets/uploads/20260918-2bedb4e08d.webp)

是的，短期内，我想我不会再下载Zcode。
